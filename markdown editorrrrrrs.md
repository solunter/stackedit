...
## Stackedit
Stackedit直接在浏览器上编辑就可以了, 可以同步Dropbox, Google Drive, github, 很方便, 保存的就只有`.md`文件, 不拖家带口的. (GoogleDrive同步的文件不晓得为什么是`.TXT`, 而且更新后不是覆盖是jinjian



> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU3Mzc3MTQ2OSw4MzEzMTE5MzgsLTU4NT
