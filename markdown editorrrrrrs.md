...
VNote的几个默认主题渲染效果其实不是很满意, 强迫症又犯了, 昨天写着写着笔记, 觉得代码高亮太丑, 去[Highlight.js](highlightjs.org[enter link description here](highlightjs.org))下载了



> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkyMzMwNzk2MywxNjk3NTE1NzM2LDgyNj
g3MDU1XX0=
-->